            ...
            VStack(spacing: 32){
                ...
                if let player = audioManager.player {
                    VStack(spacing: 5){
                        ...
                        //MARK: Playback Time
                        HStack{
                            Text (DateComponentsFormatter.positionl.string(from: player.currentTime) ?? "0:00")
                            Spacer()
                            Text (DateComponentsFormatter.positionl.string(from: player.duration - player.currentTime) ?? "0:00")
                        }
                        .font(.caption)
                        .foregroundColor(.white)
                        
                    }
                    //MARK: Playback Controll
                    HStack{
                        //MARK: Repeat Button
